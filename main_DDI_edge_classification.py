...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    if MODEL_NAME in ['RingGNN', '3WLGNN']:
        ...
        from train.train_DDI_edge_classification import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
...
def main():    
    ...
    # COLLAB
    net_params['in_dim'] = dataset.graph.number_of_nodes() # args.hidden_dim  #     dataset.graph.ndata['feat'].shape[-1]
